...
public class ExperimentalQueryEngine implements FlyweightPrototype<ExperimentalQueryEngine> {
    private static final Logger LOGGER = LoggerFactory.getLogger( ExperimentalQueryEngine.class );
    ...
    public ExperimentalQueryEngine(final QueryParser queryParser, final QueryBuilderVisitor<DocumentIterator> builderVisitor, final Object2ReferenceMap<String,Index> indexMap ) {
    ...
    public synchronized ExperimentalQueryEngine copy() {
        final ExperimentalQueryEngine newEngine = new ExperimentalQueryEngine( FlyweightPrototypes.copy( queryParser ), builderVisitor.copy(), indexMap );
